...
<head>
    ...
    <link rel="stylesheet" href="<?php printf("%s%s?v=20260505d", constant("cFrontend"), "assets/css/main.css"); ?>">
    <link rel="stylesheet" href="<?php printf("%s%s?v=20260505d", constant("cFrontend"), "assets/css/dashboard.css"); ?>">
